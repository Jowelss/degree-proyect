...
import ModalAssistence from './ModalAssistence.jsx';
...
function Eventos() {
  ...
  const [assistance, setAssistence] = useState('Asistir');
              ...
              <div>
                ...
                <div className='p-2 bg-white/10 rounded-2xl'>
                  ...
                  <div className='flex justify-between items-center'>
                    ...
                    <button
                      className='px-2 py-1 bg-pink-400 rounded-2xl font-medium'
                      onClick={openModal}
                    >
                      {assistance}
                    </button>
